# Generated by Django 3.2 on 2023-07-10 06:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_id', models.CharField(default='04564725918367817675179862312924', max_length=256, unique=True)),
                ('api_key', models.CharField(default='NYTsmgD1NpQEazwRnJwNtXOqlazpRvw7', max_length=256, unique=True)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.TextField(default='48471178274491470375828493982111', unique=True)),
                ('date', models.DateTimeField(auto_now_add=True, db_index=True, verbose_name='Дата создания')),
                ('url', models.SlugField(default='ZHpOmq27Vw9omIf63OOSplK6E5hiXSCl', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('posting_number', models.TextField(default='83400492980511719987912633237115', unique=True)),
